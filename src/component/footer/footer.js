          ...
          <div className="online-container-foorter">
            ...
            <div className="footer mb-6">
              <p className="footer-para-text paragrapg-all-component-font-family">
                Since 2016, Team OMC has remained committed to cultivating genuine, inventive, and tailored
                Digital Solutions. We eagerly anticipate embracing a customer-centric approach and forging
                lasting relationships, understanding that the team you choose holds immense significance.
                After all, we'll be collaborating closely. Whether you're embarking on a solo entrepreneurial
                journey or you represent an established business aiming to enhance your initial website, we stand
                ready to provide innovative solutions that will propel your business to new heights.
              </p>
            </div>
          </div>
